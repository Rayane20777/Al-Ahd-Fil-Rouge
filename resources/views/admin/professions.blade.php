...
<body class="text-gray-800 font-inter">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="p-6">
            ...
            <div >
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md gap-16">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{$profession->name}}</span>
                                    </td>
