                            ...
                            @foreach ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{$appointment->date}}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{$appointment->departure_hour}}<span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{$appointment->ending_hour}}<span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
